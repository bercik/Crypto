...
public final class RSA
{
     ...
     * @throws pl.rcebula.crypto.encryption.RSA.EncryptionError
     */
     ...
     * Stringa
     * @throws pl.rcebula.crypto.encryption.RSA.DecryptionError
     */
     ...
     * @throws pl.rcebula.crypto.encryption.RSA.SignError
     */
    ...
    static public class CheckSignError extends Exception
    {
    ...
    static public class EncryptionError extends Exception
    {
    ...
    static public class DecryptionError extends Exception
    {
    ...
    static public class SignError extends Exception
    {
        public SignError()
        {
        }
